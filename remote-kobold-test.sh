...
echo "=========================================================================================================================="
echo "This script will create a new Cloudflare Tunnel for your KoboldCPP instance."
...
./koboldcpp-linux-x64 WizardLM-7B-uncensored.ggmlv3.q4_K_S.bin --contextsize 4096  & ./cloudflared tunnel --url localhost:5001
